...
import {ATTR_FILTERED_CAR_MODELS, selectCarModel} from '../stores/CarModelStore';
...
class CarModelList extends React.Component {
  ...
  componentDidMount = () => connectToStore(this, STORE_CAR_MODEL_LIST, (state) => this.setState(state));
